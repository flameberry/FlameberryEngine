...
namespace Flameberry {
        ...
        : m_Specification(specification)
    {
        ...
        commandBufferAllocateInfo.level = m_Specification.IsPrimary ? VK_COMMAND_BUFFER_LEVEL_PRIMARY : VK_COMMAND_BUFFER_LEVEL_SECONDARY;
    ...
    void CommandBuffer::Begin()
    {
        ...
        commandBufferBeginInfo.flags = m_Specification.SingleTimeUsage ? VK_COMMAND_BUFFER_USAGE_ONE_TIME_SUBMIT_BIT : 0;
