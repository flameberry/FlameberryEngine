...
namespace Flameberry {
    ...
    public:
        ...
        static Ref<DescriptorSetLayout> GetLayout() { return s_CommonDescSetLayout; }
        ...
        void SetAlbedoMap(const Ref<Texture2D>& albedoMap) { m_AlbedoMap = albedoMap; }
        void SetNormalMap(const Ref<Texture2D>& normalMap) { m_NormalMap = normalMap; }
        void SetRoughnessMap(const Ref<Texture2D>& roughnessMap) { m_RoughnessMap = roughnessMap; }
        void SetAmbientOcclusionMap(const Ref<Texture2D>& ambientOccMap) { m_AmbientOcclusionMap = ambientOccMap; }
        void SetMetallicMap(const Ref<Texture2D>& metallicMap) { m_MetallicMap = metallicMap; }
    ...
    private:
        ...
        static Ref<DescriptorSetLayout> s_CommonDescSetLayout;
    ...
    {
    public:
        static void Serialize(const Ref<Material>& material, const char* path);
