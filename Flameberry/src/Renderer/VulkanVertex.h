...
namespace Flameberry {
    ...
    public:
        ...
        std::vector<VkVertexInputAttributeDescription> CreateVertexInputAttributeDescriptions() const
        {
        ...
        {
            uint32_t stride = 0;
            for (const auto& attr : m_VertexInputAttributes)
                stride += GetVertexInputAttributeSize(attr);
            return stride;
        }
    private:
