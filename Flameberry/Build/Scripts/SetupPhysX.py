...
class PhysXSDKRequirements:
    ...
    def BuildPhysXSDK(cls):
        ...
        preset = (
            ""
            if cls.__ShouldTakePresetFromUser
            else cls.__FindPreset(cls.__PhysXRootDirectory / "physx/buildtools/presets/public")
        )
    ...
    def __GetValidBuiltLibraryDirectory(cls):
        ...
        for dir in innerBinDirs:  # example dir = macos.x86_64
            ...
            for library in requiredLibraryNames:
                if not os.path.isfile(binDirectory / dir / "checked" / library) or not os.path.isfile(
                    binDirectory / dir / "release" / library
                ):
