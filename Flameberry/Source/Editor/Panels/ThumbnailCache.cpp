...
namespace Flameberry {
		...
		const std::filesystem::path& assetPath)
	{
		...
		auto thumbnail = std::static_pointer_cast<Texture2D>(
			TextureLoader::LoadTexture2DResized(absolutePath, 128, 128));
