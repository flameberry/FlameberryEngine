...
namespace Flameberry {
	...
	void Frustum::ExtractFrustumPlanes(const glm::mat4& viewProjectionMatrix)
	{
		// Left plane
		this->Planes[0] =
			glm::vec4(viewProjectionMatrix[0][3] + viewProjectionMatrix[0][0],
		...
		// Bottom plane
		this->Planes[2] =
			glm::vec4(viewProjectionMatrix[0][3] + viewProjectionMatrix[0][1],
		...
		// Near plane
		this->Planes[4] =
			glm::vec4(viewProjectionMatrix[0][2], viewProjectionMatrix[1][2],
				viewProjectionMatrix[2][2], viewProjectionMatrix[3][2]);

		// Far plane
		this->Planes[5] =
			glm::vec4(viewProjectionMatrix[0][3] - viewProjectionMatrix[0][2],
	...
	bool IsAABBInsideFrustum(const AABB& aabb, const glm::mat4& transform,
