...
namespace Flameberry {
	...
	public:
		...
		static Ref<VulkanInstance> GetCurrentInstance()
		{
			return GetCurrentContext()->m_VulkanInstance;
		}
		static Ref<VulkanDevice> GetCurrentDevice()
		{
			return GetCurrentContext()->m_VulkanDevice;
		}
		static VkPhysicalDevice GetPhysicalDevice()
		{
			return GetCurrentContext()->m_VkPhysicalDevice;
		}
		static VkPhysicalDeviceProperties GetPhysicalDeviceProperties()
		{
			VkPhysicalDeviceProperties properties{};
			vkGetPhysicalDeviceProperties(GetCurrentContext()->m_VkPhysicalDevice,
				&properties);
			return properties;
		}
		static VulkanWindow* GetCurrentWindow()
		{
			return GetCurrentContext()->m_Window;
		}
		static Ref<DescriptorPool> GetCurrentGlobalDescriptorPool()
		{
			return GetCurrentContext()->m_GlobalDescriptorPool;
		}
		static bool EnableValidationLayers() { return s_EnableValidationLayers; }

		static VkPhysicalDevice GetValidPhysicalDevice(
			const std::vector<VkPhysicalDevice>& vk_physical_devices,
			VkSurfaceKHR surface);
		static std::vector<const char*> GetValidationLayerNames()
		{
			return s_ValidationLayers;
		}

		static void SetCurrentContext(VulkanContext* pContext)
		{
			s_CurrentContext = pContext;
		}
