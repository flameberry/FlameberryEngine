	...
	static std::string GetVkResult(VkResult result)
	{
		...
		switch (result)
		{
			...
			case VK_ERROR_FRAGMENTATION:
				errorString = "VK_ERROR_FRAGMENTATION";
				break;
			case VK_ERROR_INVALID_OPAQUE_CAPTURE_ADDRESS:
				errorString = "VK_ERROR_INVALID_OPAQUE_CAPTURE_ADDRESS";
				break;
			case VK_PIPELINE_COMPILE_REQUIRED:
				errorString = "VK_PIPELINE_COMPILE_REQUIRED";
				break;
			...
			case VK_ERROR_NOT_PERMITTED_KHR:
				errorString = "VK_ERROR_NOT_PERMITTED_KHR";
				break;
			case VK_ERROR_FULL_SCREEN_EXCLUSIVE_MODE_LOST_EXT:
				errorString = "VK_ERROR_FULL_SCREEN_EXCLUSIVE_MODE_LOST_EXT";
				break;
			case VK_THREAD_IDLE_KHR:
				errorString = "VK_THREAD_IDLE_KHR";
				break;
			case VK_THREAD_DONE_KHR:
				errorString = "VK_THREAD_DONE_KHR";
				break;
			case VK_OPERATION_DEFERRED_KHR:
				errorString = "VK_OPERATION_DEFERRED_KHR";
				break;
			case VK_OPERATION_NOT_DEFERRED_KHR:
				errorString = "VK_OPERATION_NOT_DEFERRED_KHR";
				break;
			case VK_ERROR_COMPRESSION_EXHAUSTED_EXT:
				errorString = "VK_ERROR_COMPRESSION_EXHAUSTED_EXT";
				break;
...
#define VK_CHECK_RESULT(expr)                                         \
	{                                                                 \
		auto r = expr;                                                \
		FBY_ASSERT(r == VK_SUCCESS, "Vulkan process failed with: {}", \
			::Flameberry::GetVkResult(expr));                         \
	}
