...
if __name__ == '__main__':
    ...
    physX_env_cmake_string += f'set(PHYSX_INCLUDE_DIR "${{FL_SOURCE_DIR}}/{physX_include_dir.relative_to(project_dir)}")\n'
    for config, status in zip(physX_build_configs, physX_build_statuses):
        if status:
            ...
            physX_env_cmake_string += f'set(PHYSX_{config.upper()}_LIB_DIRECTORY "${{FL_SOURCE_DIR}}/{output_bin_dir_relative_path}")\n'
        else:
