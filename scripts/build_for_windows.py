...
def build_project():
    ...
    print(
        f'[FLAMEBERRY]: The Flameberry Engine project executable is generated at the path bin/{cmake_build_type}/FlameberryEditor-{platform.system()}-{platform.machine()}/FlameberryEditor_{cmake_build_type}')
